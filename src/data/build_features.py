...
def create_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    new_features = ['total_procedures', 'total_visits', 'avg_procedures_per_visit',
                    'lab_procedure_ratio', 'medication_intensity']
...
def main(cfg: DictConfig) -> None:
    try:
        ...
        processed_data_path = Path(to_absolute_path(f"{data_paths.processed}/data_featured.csv"))
